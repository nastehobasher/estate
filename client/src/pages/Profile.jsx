  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <Link
          to={"/create-listing"}
          className="bg-green-700 p-3 text-white rounded-lg uppercase text-center hover:opacity-95 disabled:opacity-80"
        >
          create listing
        </Link>
      </form>
      ...
      <button onClick={handleShowLisitngs} className="text-green-700 w-full">
        Show Listings
      </button>
